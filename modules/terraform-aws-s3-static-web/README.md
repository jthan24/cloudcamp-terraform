# terraform-aws-s3-static-web

Modulo para la creacion de un sitio estatico de S3
<!-- BEGIN_TF_DOCS -->
## Requirements
...
|------|-------------|------|---------|:--------:|
| <a name="input_bucket_name"></a> [bucket\_name](#input\_bucket\_name) | Nombre del bucket, debe ser unico | `string` | `"cloudcamp-bucket-"` | no |
...
| Name | Description |
|------|-------------|
| <a name="output_arn"></a> [arn](#output\_arn) | ARN del bucket |
| <a name="output_domain"></a> [domain](#output\_domain) | Nombre de dominio del bucket |
| <a name="output_name"></a> [name](#output\_name) | Nombre del bucket |
<!-- END_TF_DOCS -->